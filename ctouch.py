#!/home/riley/.local/bin/custom_scripts/venv/bin/python3
# -*- coding: utf-8 -*-
"""
Ctouch
==============

Touch a C file into existence.

Generate a templated C file or list of files.
...
def usage():
    print("Usage: ctouch [option] FILE...")

def help_menu():
    usage()
    print("""Generated a templated C file
...
if __name__ == "__main__":
    ...
    FM = FileMaker("ctouch", ".c")

    FM.file_template = """#include <stdio.h>
